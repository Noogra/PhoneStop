...
public class DataManager {
    ...
    public static void initDataManager(Context context){
        ...
        allCategoriesList.add(new Category()
                .setName("Devices")
                .setDrawable_img(ContextCompat.getDrawable(context,R.drawable.iphone15pro)));
        ...
        allCategoriesList.add(new Category()
                .setName("Repairs")
                .setDrawable_img(ContextCompat.getDrawable(context,R.drawable.cat_repair_service)));
